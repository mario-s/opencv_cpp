//
//  Program to illustrate ORB keypoint and descriptor extraction, and matching using FLANN-LS
//
//
...
int main() {
    std::cout << "Starting Object detect for Keypoints using ORB!\n";
    ...
    // VideoCapture object
    VideoCapture cap(0);
    cap.set(CAP_PROP_FRAME_WIDTH, 380);
